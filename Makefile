...
KNOT_PROTOCOL_PATH = ../knot-protocol-source
KNOT_HAL_PATH = ../knot-hal-source
...
$(KNOT_PROTOCOL_LIB_DIR):  $(KNOT_THING_DOWNLOAD_DIR)
	$(CP) -r $(KNOT_PROTOCOL_PATH) $(KNOT_THING_DOWNLOAD_DIR)
	$(CP) -r $(KNOT_HAL_PATH) $(KNOT_THING_DOWNLOAD_DIR)
else
$(KNOT_PROTOCOL_LIB_DIR):  $(KNOT_THING_DOWNLOAD_DIR)
...
ifdef release
	...
	$(UNZIP) -o $(KNOT_THING_TARGET) -d $(ARDUINO_LIBRARIES_PATH)
